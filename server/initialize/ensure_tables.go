...
import (
	...
	sysModel "github.com/lihongsheng/pay-gateway/model/system"
	"github.com/lihongsheng/pay-gateway/plugin/announcement/model"
	model2 "github.com/lihongsheng/pay-gateway/plugin/payment/repo/model"
...
func (e *ensureTables) MigrateTable(ctx context.Context) (context.Context, error) {
	...
	tables := []interface{}{
		...
		model2.Application{},
		model2.EventProcessRecord{},
		model2.Merchant{},
		model2.NotifyRecord{},
		model2.PaymentAccount{},
		model2.PaymentExpireRecord{},
		model2.PaymentMethod{},
		model2.PaymentOrder{},
		model2.PaymentOrderProduct{},
		model2.PaymentRequestLog{},
		model2.RefundOrder{},
		model2.RefundOrderProduct{},
		model2.RouterAccountStatistic{},
		model2.Statistic{},
		model2.TradeStatistic{},
	}

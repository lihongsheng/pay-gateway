...
import (
	...
	systemRes "github.com/lihongsheng/pay-gateway/model/system/response"
...
func (b *BaseApi) Register(c *gin.Context) {
	...
	if r.UserType == enum.UserType_Mch {
		if r.MchNo == "" {
	...
	if claims.UserType.ISMch() {
		r.MchNo = claims.HaveMchNO
	}
	...
	global.GVA_LOG.Info("用户注册信息", zap.Any("r", r))
	user := &system.SysUser{Username: r.Username, NickName: r.NickName, Password: r.Password, HeaderImg: r.HeaderImg,
		AuthorityId: r.AuthorityId, Authorities: authorities, Enable: r.Enable, Phone: r.Phone, Email: r.Email, MchNo: r.MchNo, UserType: r.UserType}

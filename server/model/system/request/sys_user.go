...
import (
	...
	common "github.com/lihongsheng/pay-gateway/model/common/request"
...
type Register struct {
	...
	MchNo        string        `json:"mchNo" swaggertype:"string" example:"string 商户"`
	UserType     enum.UserType `json:"userType" example:"用户类型"`
}
...
type ChangeUserInfo struct {
	...
	MchNo        string                `json:"mchNo" swaggertype:"int" example:"int 商户id"`
}

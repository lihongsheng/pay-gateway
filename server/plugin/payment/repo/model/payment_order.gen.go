...
type PaymentOrder struct {
	...
	Status            int64     `gorm:"column:status;type:tinyint;not null;comment:支付状态" json:"status"`                                                               // 支付状态
	...
	RedirectURL       string    `gorm:"column:redirect_url;type:varchar(256);not null;comment:支付完成跳转url" json:"redirect_url"`                                         // 支付完成跳转url
	NotifyURL         string    `gorm:"column:notify_url;type:varchar(256);not null;comment:异步通知url" json:"notify_url"`                                               // 异步通知url

...
type PaymentOrderProduct struct {
	...
	MchNo       string    `gorm:"column:mch_no;type:varchar(100);comment:商户编号" json:"mch_no"`           // 商户编号
	...
	OrderNo     string    `gorm:"column:order_no;type:varchar(64);idx_order_no_idx;not null;comment:订单号" json:"order_no"`           // 订单号

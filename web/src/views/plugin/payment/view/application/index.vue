    ...
    <el-card shadow="never" class="search-card">
      <el-form :inline="true" :model="searchInfo" class="search-form">
        ...
        <el-form-item label="商户">
          <el-select v-model="searchInfo.mch_no" filterable placeholder="请选择商户" clearable remote :remote-method="remoteSearchMchVenuer" :loading="venuerMchLoading" style="width:220px">
...
import ApplicationForm from "../../form/application-form.vue"
...
// 组件挂载时获取商户列表
onMounted(() => {
  const res =  mchList({mch_no: route.query.mch_no, page:1, page_size:10})
  if (res.code === 0) {
...
/* 二维码弹窗样式 */
.qrcode-dialog { padding: 10px; }
.qrcode-dialog .el-slider { margin-top: 8px; }
</style>